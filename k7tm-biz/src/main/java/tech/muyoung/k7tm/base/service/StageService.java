...
public interface StageService {
    ...
    */
    Map<String,Object> queryAll(StageQueryCriteria criteria, Pageable pageable);
    ...
    */
    List<StageDto> queryAll(StageQueryCriteria criteria);
    ...
    * @return StageDto
    */
    StageDto create(Stage resources);

    /**
    * 编辑
    * @param resources /
    */
    void update(Stage resources);
    ...
    * @throws IOException /
    */
    void download(List<StageDto> all, HttpServletResponse response) throws IOException;
}